...
**Binance Pay.** Scan the code below in the Binance app, or open the
[payment link](https://app.binance.com/uni-qr/YVVoCnjG) on a phone that
has the app installed. Either way it should show **Kinan125** as the
recipient before you confirm anything.

<img src="docs/assets/binance-support-qr.jpg" alt="Binance Pay / USDT support QR code" width="240">
